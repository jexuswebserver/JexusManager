...
namespace Tests.RequestFiltering.Headers
{
    ...
    public class HeadersFeatureSiteTestFixture
    {
        ...
        public async void TestRemoveInherited()
        {
            ...
            XmlAssert.Equal(Path.Combine("RequestFiltering", "Headers", "expected_remove.site.config"), Path.Combine("Website1", "web.config"));
        }
        ...
        public async void TestRemove()
        {
            ...
            XmlAssert.Equal(Helper.IsRunningOnMono() ? OriginalMono : Original, Current);
            XmlAssert.Equal(Path.Combine("RequestFiltering", "Headers", "expected_remove1.site.config"), Path.Combine("Website1", "web.config"));
        }
        ...
        public async void TestAdd()
        {
            ...
            XmlAssert.Equal(Helper.IsRunningOnMono() ? OriginalMono : Original, Current);
            XmlAssert.Equal(Path.Combine("RequestFiltering", "Headers", "expected_add.site.config"), Path.Combine("Website1", "web.config"));
        }
    }
}
