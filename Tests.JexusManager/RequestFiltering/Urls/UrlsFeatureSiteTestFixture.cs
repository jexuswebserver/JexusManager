...
namespace Tests.RequestFiltering.Urls
{
    ...
    public class UrlsFeatureSiteTestFixture
    {
        ...
        public async void TestRemoveInherited()
        {
            ...
            XmlAssert.Equal(Path.Combine("RequestFiltering", "Urls", "expected_remove.site.config"), Path.Combine("Website1", "web.config"));
        }
        ...
        public async void TestRemove()
        {
            ...
            XmlAssert.Equal(Helper.IsRunningOnMono() ? OriginalMono : Original, Current);
            XmlAssert.Equal(Path.Combine("RequestFiltering", "Urls", "expected_remove1.site.config"), Path.Combine("Website1", "web.config"));
        }
        ...
        public async void TestRemoveDeny()
        {
            ...
            XmlAssert.Equal(Helper.IsRunningOnMono() ? OriginalMono : Original, Current);
            XmlAssert.Equal(Path.Combine("RequestFiltering", "Urls", "expected_remove1_deny.site.config"), Path.Combine("Website1", "web.config"));
        }
        ...
        public async void TestAdd()
        {
            ...
            XmlAssert.Equal(Helper.IsRunningOnMono() ? OriginalMono : Original, Current);
            XmlAssert.Equal(Path.Combine("RequestFiltering", "Urls", "expected_add.site.config"), Path.Combine("Website1", "web.config"));
        }
